...
- [ ] **MOB-01**: User can navigate the app on 375px viewport without horizontal scroll or overflow
- [ ] **MOB-02**: Sidebar collapses to Sheet drawer triggered by hamburger icon on mobile
