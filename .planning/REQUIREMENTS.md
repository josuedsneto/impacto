...
- [x] **EXP-03**: User can download breakeven analysis as CSV from the breakeven page
- [x] **EXP-04**: User can print/save simulation page to PDF via browser print dialog (`@media print` strategy)
